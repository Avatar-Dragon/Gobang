...
namespace Gobang
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
           ...
           //}
            ...
            if (rootFrame == null)
            {
                ...
                {
                    //TODO: 从之前挂起的应用程序加载状态
                    MainPage.gameStart = (bool)ApplicationData.Current.LocalSettings.Values["gameStart"];
                    MainPage.isAIOrNot = (bool)ApplicationData.Current.LocalSettings.Values["isAIOrNot"];
                }
        ...
        private void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            ApplicationData.Current.LocalSettings.Values["gameStart"] = MainPage.gameStart;
            ApplicationData.Current.LocalSettings.Values["isAIOrNot"] = MainPage.isAIOrNot;
            if (MainPage.gameStart)
            {
                db.storeData(MainPage.matrix);
            }
            deferral.Complete();
        }
