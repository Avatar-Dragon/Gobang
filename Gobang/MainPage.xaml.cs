...
namespace Gobang
{
    ...
    {
        //定义全局变量 
        public static int matrixWidth = 21;
        ...
        public MainPage()
        {
            ...
            gridWidth = (chessBoard.Width - 30) / 20;
        }
        ...
        public void InstallChessboard()
        {
            ...
            for (int i = 0; i < matrixWidth; i++)
            {
                ...
                xLine.Y1 = xLine.Y2 = yLine.X1 = yLine.X2 = (BoardHei - 30) / 20 * i + 15;
        ...
        public void drawChess()
        {
            for (int i = 0; i < 21; i++)
            {
                for (int j = 0; j < 21; j++)
                {
                    ...
                    Canvas.SetLeft(newChess, j * (chessBoard.Width - 30) / 20 + 5);
                    Canvas.SetTop(newChess, i * (chessBoard.Width - 30) / 20 + 5);
        ...
        public bool setNewChess(Ellipse newChess)
        {
            if (matrix[newChess_row, newChess_col] == 0)
            {
                ...
                //设置棋子的位置
                Canvas.SetLeft(newChess, newChess_col * (chessBoard.Width - 30) / 20 + 5);
                Canvas.SetTop(newChess, newChess_row * (chessBoard.Width - 30) / 20 + 5);
                chessBoard.Children.Add(newChess);
                return true;
            }
            else
